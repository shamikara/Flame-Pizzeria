...
CREATE TABLE `recipecomment` (
  ...
  PRIMARY KEY (`id`),
  KEY `RecipeComment_authorId_fkey` (`authorId`),
  KEY `RecipeComment_recipeId_fkey` (`recipeId`),
  CONSTRAINT `RecipeComment_authorId_fkey` FOREIGN KEY (`authorId`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
