...
// export default function DashboardLayoutComponent({ // Renamed to avoid confusion
//   children,
//   user, // <-- Accept the user prop
// }: {
//   children: React.ReactNode;
//   user: UserPayload; // <-- Define the prop type
// }) {
//   // ... handleLogout function stays the same
...
//           {/* ... sidebar content */}
//           <nav className="relative z-10 flex-1 overflow-auto py-4">
//             {/* Pass the user's role to the Nav component */}
...
//                 {/* ... mobile logo */}
//                 <div className="relative z-10 py-4">
//                    {/* Pass the user's role to the Nav component here too */}
//                   <DashboardNav userRole={user.role} />
//                 </div>
//               </SheetContent>
//             </Sheet>
//             {/* ... right-aligned header items and dropdown */}
//           </header>
